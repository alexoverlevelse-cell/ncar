-- OlehDK: схема БД (см. CLAUDE.md). Названия таблиц и часть комментариев
-- остались от прежней P2P-модели NCar с несколькими публикующими —
-- сейчас в проекте один администратор (Олег), но менять структуру ради
-- переименования смысла нет.
--
